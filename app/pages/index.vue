  ...
  <div>
    <section class="hero-shell relative min-h-[78svh] flex items-center overflow-hidden bg-[#2a1e2a] dark:bg-zinc-900 -mt-[var(--ui-header-height)] pt-[calc(var(--ui-header-height)+1rem)]">
      ...
      <div class="absolute inset-0 pointer-events-none">
        ...
        <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#2a1e2a]/60" />
        <div class="grain-noise grain-noise-soft" />
      </div>
      ...
      <div class="relative z-10 w-full px-6 mx-auto max-w-7xl py-20 sm:py-24">
        <div class="max-w-5xl">
          <p class="mb-8 text-xs sm:text-sm tracking-[0.4em] uppercase text-white/60 font-light animate-fade-down">
            <span class="inline-block w-10 h-px bg-white/40 align-middle mr-3" />
            {{ t('hero.eyebrow') }}
          </p>
      ...
      <div class="relative max-w-7xl mx-auto px-6 py-24 sm:py-32">
        <div class="max-w-3xl mb-16 sm:mb-20 scroll-fade-in">
          <p class="mb-5 text-xs sm:text-sm tracking-[0.4em] uppercase text-brand-600 dark:text-brand-400 font-light">
            <span class="inline-block w-10 h-px bg-brand-500/60 align-middle mr-3" />
            {{ t('pillars.eyebrow') }}
          </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  v-if="pillar.key === 'foodchat'"
                  class="relative h-full flex flex-col justify-end gap-3"
                >
                  <div class="flex items-start gap-2 max-w-[75%] self-start float-soft">
                    ...
                    <div class="px-4 py-3 rounded-2xl rounded-tl-sm bg-white dark:bg-zinc-100 text-zinc-900 text-sm leading-snug shadow-sm">
                      {{ t('mockups.foodchat.userMessage') }}
                    </div>
                  </div>
                  <div class="flex items-start gap-2 max-w-[90%] self-end w-full">
                      ...
                      <table class="w-full text-left text-xs border-t border-zinc-200">
                        <thead>
                          <tr class="bg-zinc-50 text-[10px] uppercase tracking-wider text-zinc-500">
                            ...
                            <th class="px-3 py-1.5 font-medium">
                              {{ t('mockups.foodchat.table.dishHeader') }}
                            </th>
                            <th class="px-3 py-1.5 font-medium text-right">
                              {{ t('mockups.foodchat.table.kcalHeader') }}
                            </th>
                          </tr>
                        </thead>
                        <tbody class="text-zinc-700">
                          <tr class="border-t border-zinc-100">
                            <td class="px-3 py-1.5 font-medium text-brandp-700">
                              {{ t('mockups.foodchat.table.breakfast') }}
                            </td>
                            <td class="px-3 py-1.5">
                              {{ t('mockups.foodchat.table.breakfastDish') }}
                            </td>
                          ...
                          <tr class="border-t border-zinc-100">
                            <td class="px-3 py-1.5 font-medium text-brandp-700">
                              {{ t('mockups.foodchat.table.lunch') }}
                            </td>
                            <td class="px-3 py-1.5">
                              {{ t('mockups.foodchat.table.lunchDish') }}
                            </td>
                            <td class="px-3 py-1.5 text-right tabular-nums">
                              540
                            </td>
                          ...
                          <tr class="border-t border-zinc-100">
                            <td class="px-3 py-1.5 font-medium text-brandp-700">
                              {{ t('mockups.foodchat.table.snack') }}
                            </td>
                            <td class="px-3 py-1.5">
                              {{ t('mockups.foodchat.table.snackDish') }}
                            </td>
                            <td class="px-3 py-1.5 text-right tabular-nums">
                              180
                            </td>
                          ...
                          <tr class="border-t border-zinc-100">
                            <td class="px-3 py-1.5 font-medium text-brandp-700">
                              {{ t('mockups.foodchat.table.dinner') }}
                            </td>
                            <td class="px-3 py-1.5">
                              {{ t('mockups.foodchat.table.dinnerDish') }}
                            </td>
                            <td class="px-3 py-1.5 text-right tabular-nums">
                              610
                            </td>
                    ...
                    <div class="w-8 h-8 rounded-full bg-brandp-100 border border-brandp-200 shrink-0 flex items-center justify-center">
                      <UIcon
                        ...
                        class="w-4 h-4 text-brandp-600"
                      />
                    </div>
                  </div>
                  <div class="flex items-center gap-2 text-xs text-zinc-500 self-end">
                    <span class="flex items-center gap-1">
                      <span class="w-1.5 h-1.5 rounded-full bg-brandp-500 animate-pulse" />
                      {{ t('mockups.foodchat.typing') }}
                    </span>
                  </div>
                </div>
                ...
                <div
                  v-else-if="pillar.key === 'foodscholar'"
                ...
                >
                  <div class="w-full max-w-md mx-auto rounded-2xl bg-white dark:bg-zinc-100 p-5 shadow-xl float-soft">
                    <p class="text-xs text-zinc-500 italic leading-snug mb-2">
                      {{ t('mockups.foodscholar.question') }}
                    </p>
                    <p class="text-sm leading-snug text-zinc-900 mb-4">
                      <i18n-t
                        keypath="mockups.foodscholar.answer"
                        tag="span"
                      >
                        <template #ref1>
                          <sup class="text-brand-600 font-semibold ml-0.5">1</sup>
                        </template>
                        <template #ref2>
                          <sup class="text-brand-600 font-semibold ml-0.5">2</sup>
                        </template>
                        <template #ref3>
                          <sup class="text-brand-600 font-semibold ml-0.5">3</sup>
                        </template>
                      </i18n-t>
                    </p>
                      ...
                      <ul class="space-y-1.5">
                        ...
                        <li class="flex items-center gap-2 text-[11px] text-zinc-700">
                          ...
                          <UIcon
                            ...
                            class="w-3 h-3 text-brand-600 shrink-0"
                          />
                          <span class="font-medium text-zinc-800">{{ t('mockups.foodscholar.textbookLabel') }}</span>
                          <span class="text-zinc-500 truncate">· {{ t('mockups.foodscholar.textbookTitle') }}</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div
                  v-else-if="pillar.key === 'recipewrangler'"
                  class="relative h-full flex items-center"
                >
                  <div class="w-full max-w-sm mx-auto rounded-2xl bg-white dark:bg-zinc-100 p-4 shadow-xl float-soft">
                    ...
                    <h4 class="text-base font-medium text-zinc-900 mb-3">
                      {{ t('mockups.recipewrangler.recipeTitle') }}
                    </h4>
                    ...
                    <div class="flex items-center justify-between text-[11px] text-zinc-500">
                      <span class="inline-flex items-center gap-1">
                        <UIcon
                          name="i-lucide-leaf"
                          class="w-3 h-3 text-brandg-600"
                        />
                        {{ t('mockups.recipewrangler.lowImpact') }}
                      </span>
                      <span class="inline-flex items-center gap-1 text-brandg-700 font-medium">
                        {{ t('mockups.recipewrangler.compare') }}
                        <UIcon
    ...
    <section class="relative overflow-hidden bg-[#1c1418] dark:bg-zinc-950 text-white">
      <div class="absolute inset-0 pointer-events-none">
        ...
        />
        <div class="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-black/40" />
        <div class="grain-noise grain-noise-soft" />
      </div>
      ...
      <div class="relative max-w-6xl mx-auto px-6 py-28 sm:py-36">
        <div class="max-w-4xl mx-auto text-center scroll-fade-in">
          <p class="mb-8 text-xs sm:text-sm tracking-[0.4em] uppercase text-white/60 font-light">
            <span class="inline-block w-10 h-px bg-white/40 align-middle mr-3" />
            {{ t('manifesto.eyebrow') }}
            <span class="inline-block w-10 h-px bg-white/40 align-middle ml-3" />
          </p>
      ...
      <div class="relative max-w-7xl mx-auto px-6 py-24 sm:py-32">
        <div class="max-w-3xl mb-16 sm:mb-20 scroll-fade-in">
          <p class="mb-5 text-xs sm:text-sm tracking-[0.4em] uppercase text-brandg-700 dark:text-brandg-400 font-light">
            <span class="inline-block w-10 h-px bg-brandg-600/60 align-middle mr-3" />
            {{ t('steps.eyebrow') }}
          </p>
          <h2 class="text-4xl sm:text-5xl lg:text-6xl font-light text-zinc-900 dark:text-white leading-[1.05] tracking-tight">
            {{ t('steps.heading') }}
        ...
        <div class="relative grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div class="hidden md:block absolute top-10 left-[16%] right-[16%] h-px border-t border-dashed border-zinc-400/40 dark:border-zinc-700" />
